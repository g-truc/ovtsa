...
namespace glm
{
	...
	typename vecType::bool_type lessThan(
		vecType const & x, 
		vecType const & y);
	...
	//! (From GLSL 1.30.08 specification, section 8.6)
    template <typename vecType> 
	typename vecType::bool_type lessThanEqual(
		vecType const & x, 
		vecType const & y);
	...
	//! (From GLSL 1.30.08 specification, section 8.6)
    template <typename vecType> 
	typename vecType::bool_type greaterThan(
		vecType const & x, 
		vecType const & y);
	...
	//! (From GLSL 1.30.08 specification, section 8.6)
    template <typename vecType> 
	typename vecType::bool_type greaterThanEqual(
		vecType const & x, 
		vecType const & y);
	...
	//! (From GLSL 1.30.08 specification, section 8.6)
    template <typename vecType> 
	typename vecType::bool_type notEqual(
		vecType const & x, 
		vecType const & y);
	...
	//! (From GLSL 1.30.08 specification, section 8.6)
    template <typename vecType> 
	typename vecType::bool_type not_(
		vecType const & x);
